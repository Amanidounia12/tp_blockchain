...
contract SingingVotesTest is Test {
    ...
    function testValidSingerCheck() public view {
        assert(singingVotes.validSinger("Alice"));
        assert(singingVotes.validSinger("Bob"));
        assert(singingVotes.validSinger("Charlie"));
        assert(!singingVotes.validSinger("InvalidSinger"));
    }
